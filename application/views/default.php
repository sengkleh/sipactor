...
<html lang="en">
  <head>
    ...
    <!-- bootstrap-wysiwyg -->
    <link href="<?=base_url('asset')?>/vendors/google-code-prettify/bin/prettify.min.css" rel="stylesheet">
  ...
  <body class="nav-md">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?=site_url('index.php/Ctest/index')?>">Dashboard</a></li>
   ...
   <script src="<?=base_url('asset')?>/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <!-- bootstrap-wysiwyg -->
    <script src="<?=base_url('asset')?>/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js"></script>
    <script src="<?=base_url('asset')?>/vendors/jquery.hotkeys/jquery.hotkeys.js"></script>
    <script src="<?=base_url('asset')?>/vendors/google-code-prettify/src/prettify.js"></script>
