...
<div class="right_col" role="main">
    ...
    <div class="page-title">
        ...
        <a href="<?php echo site_url('Ctr_supplier/tambahsupplier')?>" class ="btn btn-primary btn-sm mb-2 mt-6"><i class="fa fa-plus" aria-hidden="true"></i> Add Supplier</a>
        </div>
...
<div class="clearfix"></div>
    <div class="row">
        ...
        <div class="x_panel">
            <div class="x_title">
            <h2>Tabel Data Suppliers<small>!!</small></h2>
                                        ...
                                        foreach($row->result() as $key=> $data) { ?>
                                            ...
                                            <td class="text-center" widte="160px">
                                               <!--form action update delete-->
                                                <Form action="<?php echo site_url('Ctr_supplier/deletsupplier')?>" method="POST">
                                                    <a href="<?php echo site_url('Ctr_supplier/editsupplier/'. $data->id_supplier)?>" class ="btn btn-info btn-sm mb-2"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update</a>
